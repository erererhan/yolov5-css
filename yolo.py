...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolov_C2f.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
        super().__init__()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg", type=str, default="yolov_C2f.yaml", help="model.yaml")
